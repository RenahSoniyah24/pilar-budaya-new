            ...
            <div className="col-md-12 col-lg-10">
              <div className="wrap d-md-flex">
                <div
                  className="img"
                  style={{
                    backgroundImage: `url("assets/images/gallery/Frame 2.jpg")`,
                  }}
                ></div>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="w-100">
                      <p className="social-media d-flex justify-content-end">
                        <NavLink
                          className="nav-link social-icon d-flex px-0 py-0 align-items-center justify-content-center"
                          to="/"
                          exact
                        >
                          <FaHome size={20} color="#e3b04c" />
                        </NavLink>
                      </p>
                    </div>
                  </div>
